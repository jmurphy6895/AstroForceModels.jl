...
"""
@with_kw struct ThirdBodyModel <: AbstractNonPotentialBasedForce
    body::CelestialBody
    ephem_type::Symbol = Vallado()
end

#TODO: EXPAND TO SPICE WITH SPICE
export get_position
"""
...
"""
function get_position(ephem_type::Val{:Vallado}, body::CelestialBody, time::Number)
    ...
    R_MOD2J2000 = r_eci_to_eci(MOD(), J2000(), time, srp_model.eop_data)

    return R_MOD2J2000 * pos_mod

end

@valsplit 1 function get_position(ephem_type::Symbol, body::CelestialBody, time::Number)
...
function (model::ThirdBodyModel)(t::Number)
    return get_position(model.ephem_type, model.body, t)
end
