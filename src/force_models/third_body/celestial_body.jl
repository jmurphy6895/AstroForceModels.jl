...
function CelestialBody(name::String; T::DataType=Float64, )
    ...
    elseif lowercase(name) == "enceladus"
        ...
        error("Celestial body $name not recognized or not yet supported. Consider creating custom CelestialBody instead.")
    end
end
...
function CustomCelestialBody(
    ...
    return CelestialBody(
        name, central_body, naif_id, ephemeris, epoch, μ, Req
    )
end
